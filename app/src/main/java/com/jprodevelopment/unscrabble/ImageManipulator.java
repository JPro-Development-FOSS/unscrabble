...
public class ImageManipulator {
    ...
    public void setmOpenCvCameraView(CameraBridgeViewBase mOpenCvCameraView) {
    ...
    public Mat getmIntermediateMat() {
        return mIntermediateMat;
    }

    public void setmIntermediateMat(Mat mIntermediateMat) {
        this.mIntermediateMat = mIntermediateMat;
    }
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        return processMat(inputFrame.rgba(), inputFrame.gray());
    }

    @VisibleForTesting
    Mat processMat(Mat rgba, Mat gray) {
